...
/** Classe permettant de créer une fiche d'informations sur l'espèce Panda
 * 
 * @author darco
 *
 */
public class FichePanda extends JFrame {
	...
	/** zone de texte dans lqauelle sera inscrit les informations */
	
	private TextArea informations = new TextArea();

	/** couleur qui sera utilisée come background de la fiche */
	...
	public static void main (String [] args) {
		...
		FichePanda fiche = new FichePanda();
