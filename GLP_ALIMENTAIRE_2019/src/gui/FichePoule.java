...
/** Classe permettant de créer une fiche d'informations sur l'espèce Poule
 * 
 * @author darco
 *
 */
public class FichePoule extends JFrame {
	...
	public static void main (String [] args) {
		...
		FichePoule fiche = new FichePoule();
